...
# FILE_FOLEDER ='C:\\Users\\SHASHANAK\\Desktop\\share'
def show_files(username):
    return (os.listdir(path='C:\\Users\\SHASHANAK\\Desktop\\project\\files\\'+username))
       
app = Flask(__name__)
UPLOAD_FOLDER ='C:\\Users\\SHASHANAK\\Desktop\\project\\files\\'
...
def validate():
    ...
    if user!="" and password!="" and repeat_password!="":
        if user in l:
            ...
            path=r'C:\\Users\\SHASHANAK\\Desktop\\project\\files\\'
            os.mkdir(path+user)
...
def delete():
    if request.method=='GET':
        ...
        print(choose)
        os.remove(path='C:\\Users\\SHASHANAK\\Desktop\\project\\files\\'+session.get('username', None)+'\\'+(choose))
        return redirect("http://127.0.0.1:4000/home",code=302)
